...
// Sat Sep  9 02:48:40 2017 by ROOT version 5.34/36
// from TTree LHEF/Analysis tree
// found on file: monotop_rightHanded_leptonic.root
//////////////////////////////////////////////////////////

#ifndef monotop_gen_lept_h
#define monotop_gen_lept_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   const Int_t kMaxRwgt = 145;
   const Int_t kMaxParticle = 9;

class monotop_gen_lept : public TSelector {
public :
   ...
   monotop_gen_lept(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~monotop_gen_lept() { }
   ...
   ClassDef(monotop_gen_lept,0);
};

#endif

#ifdef monotop_gen_lept_cxx
void monotop_gen_lept::Init(TTree *tree)
{
...
Bool_t monotop_gen_lept::Notify()
{
...
#endif // #ifdef monotop_gen_lept_cxx
