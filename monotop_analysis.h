...
// Sun Sep  3 18:29:05 2017 by ROOT version 5.34/36
// from TTree Delphes/Analysis tree
// found on file: tag_1_delphes_events.root
//////////////////////////////////////////////////////////

#ifndef monotop_analysis_h
#define monotop_analysis_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   const Int_t kMaxParticle = 3651;
   const Int_t kMaxTrack = 175;
   const Int_t kMaxTower = 289;
   const Int_t kMaxEFlowTrack = 175;
   const Int_t kMaxEFlowPhoton = 113;
   const Int_t kMaxEFlowNeutralHadron = 151;
   ...
   const Int_t kMaxFatJet = 4;
   const Int_t kMaxMissingET = 1;
   const Int_t kMaxScalarHT = 1;

class monotop_analysis : public TSelector {
public :
   ...
   monotop_analysis(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~monotop_analysis() { }
   ...
   ClassDef(monotop_analysis,0);
};

#endif

#ifdef monotop_analysis_cxx
void monotop_analysis::Init(TTree *tree)
{
...
Bool_t monotop_analysis::Notify()
{
...
#endif // #ifdef monotop_analysis_cxx
